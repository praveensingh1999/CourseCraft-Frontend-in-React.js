                ...
                <Td className="flex flex-1 gap-x-4">
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    {course.status === COURSE_STATUS.DRAFT ? (
                      <p className="flex w-fit flex-row items-center gap-2 rounded-full bg-[#2C333F] px-2 py-0.5 text-[12px] font-medium text-[#F37290]">
                        <HiClock size={14} />
                        Drafted
                      </p>
                    ) : (
                      <p className="flex w-fit flex-row items-center gap-2 rounded-full bg-[#2C333F] px-2 py-0.5 text-[12px] font-medium text-[#E7C009]">
