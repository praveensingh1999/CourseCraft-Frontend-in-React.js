...
function PublishCourse() {
  ...
  return (
    <div className="rounded-md border border-[#2C333F] bg-[#161D29] p-6">
        ...
        <div className="my-6 mb-8">
          <label htmlFor="public" className="inline-flex items-center text-lg">
            <input
              ...
              id="public"
              {...register("public")}
              className="border-[#888888] h-4 w-4 rounded bg-[#F1F2FF]00 text-[#6E727F] focus:ring-2 focus:ring-[#F1F2FF]"
            />
