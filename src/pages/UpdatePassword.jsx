     ...
     <div className="grid min-h-[calc(100vh-3.5rem)] place-items-center">
      {loading ? (
        ...
        <div className="max-w-[500px] p-4 lg:p-8">
          ...
          <p className="my-4 text-[1.125rem] leading-6.5 text-[#AFB2BF]">
          ...
          <form onSubmit={handleOnSubmit}>
            <label className="relative">
              ...
              <input
                ...
                className="form-style w-full pr-10 !important"
              />
              <span
            ...
            <label className="relative mt-3 block">
              ...
              <input
                ...
                className="form-style w-full !important pr-10"
              />
              <span
            ...
            <button
              type="submit"
              className="mt-6 w-full rounded-lg bg-[#FFD60A] py-3 px-3 font-medium text-[#000814]"
            >
              Reset Password
            </button>
          </form>
