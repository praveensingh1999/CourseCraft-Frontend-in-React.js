  ...
  return (
     <div>
      <section className="bg-[#2C333F]">
        <div className="relative mx-auto flex w-11/12 max-w-[1260px] flex-col justify-between gap-10 text-center text-[#f7f8fa]">
          <header className="mx-auto py-20 text-4xl font-semibold lg:w-[65%]">
            ...
            <p className="mx-auto mt-3 text-center text-base font-medium text-[#838894] lg:w-[95%]">
              Course Craft is at the forefront of driving innovation in online
      ...
      <StatsComponenet />
      <section className="mx-auto mt-20 flex w-11/12 max-w-[1260px] flex-col justify-between gap-10 text-[#f9fafb]">
        <LearningGrid />
        <ContactFormSection />
      </section>
