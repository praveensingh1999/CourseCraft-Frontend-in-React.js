    ...
    <>
      ...
      <div className="relative w-full bg-[#161D29]">
        <div className="mx-auto px-4 lg:w-[1260px]">
          <div className="grid min-h-[450px] max-w-[810px] py-8 text-[#F1F2FF]">
            {/* MOBILE IMAGE */}
          ...
          {/* ===== COURSE CARD (DESKTOP) ===== */}
          <div className="hidden lg:block lg:absolute right-[75px] top-[60px] w-[410px]">
            <CourseDetailsCard
              course={response.data.courseDetails}
              setConfirmationModal={setConfirmationModal}
              handleBuyCourse={handleBuyCourse}
      ...
      {/* ===== COURSE CARD (MOBILE – SAME COMPONENT) ===== */}
