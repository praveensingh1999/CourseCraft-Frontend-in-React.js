     ...
     <div>
      ...
      <div className="relative mx-auto flex w-11/12 max-w-[1260px] flex-col items-center justify-between gap-8 text-white">
        ...
        <div className="text-center text-4xl font-semibold">
          ...
          <HighlightText text={"Course Craft"} />
        </div>
          ...
          <CodeBlocks
            ...
            heading={
              <div className="w-full text-4xl font-bold ">
                Start
                <HighlightText text={"coding in seconds"} />  and build amazing apps.
              </div>
            }
            subheading={
      ...
      <div className="bg-[#F9F9F9] text-[#2C333F]">
        ...
        <div className="mx-auto flex w-11/12 max-w-[1260px] flex-col items-center justify-between gap-8 ">
          ...
          <div className="mb-10 mt-[-100px] flex flex-col justify-between gap-7 lg:mt-20 lg:flex-row lg:gap-0">
            <div className="text-4xl  lg:w-[45%] font-bold">
       ...
       {/* Section 3 */}
      <div className="relative mx-auto my-20 flex w-11/12 max-w-[1260px] flex-col items-center justify-between gap-8  text-white">
